package princess.common.core.util.json;


import base.collect.Listx;
import base.collect.Mapx;
import princess.common.plugin.jackson.handler.JacksonHandler;
...
public class JsonUtil {
     ...
     */
    public synchronized static void setHandler(JsonHandler handler) {
        HANDLER = handler;
    }
}
